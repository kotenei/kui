    ...
    render() {
        return (
            <div>
                ...
                <h3>线形进度条 — 百分比内显</h3>
                <div className="k-example">
                    <Progress percent={10} kStyle="primary" strokeWidth="20" textInside={true} />
                    <Progress percent={40} kStyle="warning" strokeWidth="20" textInside={true} />
                    <Progress percent={100} kStyle="success" strokeWidth="20" textInside={true} />
                    <Progress percent={80} kStyle="danger" strokeWidth="20" textInside={true} />
                </div>
                <h3>环形进度条</h3>
                <div className="k-example">
                ...
                <table className="k-table k-table-hover k-table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>kStyle</td>
                            <td>风格，可选值 'primary' 'info' 'success' 'warning' 'danger'，只在type为line下有效</td>
                            <td>string</td>
                            <td>—</td>
                        </tr>
                        <tr>
