            ...
            <div>
                ...
                <div className="k-example">
                    <Steps current={1} status="process"  >
                        <Step title="第一步" description="这里是描述这里是描述这里是描述这里是描述这里是描述这里是描述这里是描述这里是描述这里是描述这里是描述这里是描述这里是描述这里是描述这里是描述这里是描述这里是描述这里是描述" />
                ...
                <div className="k-example">
                    <Steps current={1} status="process" >
                        <Step icon={<Icon type="user" />} title="第一步" description="这里是描述这里是描述这里是描述这里是描述这里是描述这里是描述这里是描述这里是描述这里是描述这里是描述这里是描述这里是描述这里是描述这里是描述这里是描述这里是描述这里是描述" />
                        <Step icon={<Icon type="idcard" />} title="第二步" description="这里是描述" />
                        <Step icon={<Icon type="smileo" />} title="完成" description="这里是描述" />
                    </Steps>
                </div>
                <h3>垂直步骤条</h3>
                <div className="k-example">
                ...
                <h3>垂直步骤条-迷你版</h3>
                <div className="k-example">
                    <Steps direction="vertical" current={1} status="process" kSize="sm" >
                        <Step title="第一步" description="这里是描述这里是描述这里是描述这里是描述这里是描述这里是描述这里是描述这里是描述这里是描述这里是描述这里是描述这里是描述这里是描述这里是描述这里是描述这里是描述这里是描述" />
                        <Step title="第二步" description="这里是描述" />
                        <Step title="完成" description="这里是描述" />
                    </Steps>
                ...
                <table className="k-table k-table-hover k-table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>status</td>
                            <td>指定状态。当不配置该属性时，会使用 Steps 的 current 来自动指定状态。可选 'wait' 'process' 'finish' 'error'</td>
                            <td>string</td>
                            <td>'wait'</td>
                        </tr>
                    </tbody>
