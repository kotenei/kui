    ...
    return (
      <div className="story-demo-table">
        <Table dataSource={data}>
          <TableColumn title="FirstName" filed="firstName" />
          <TableColumn title="LastName" filed="lastName" />
          <TableColumn title="Age" filed="age" />
          <TableColumn title="Address" filed="address" />
          <TableColumn title="Status" filed="status" />
        </Table>
      </div>
    );
  }
