        ...
        return (
            <div>
                ...
                <div className="k-example">
                    ...
                    <Button kStyle="primary" raised >primary</Button>&nbsp;&nbsp;
                    <Button kStyle="info" raised>info</Button>&nbsp;&nbsp;
                    <Button kStyle="success" raised>success</Button>&nbsp;&nbsp;
                    <Button kStyle="warning" raised>warning</Button>&nbsp;&nbsp;
                    <Button kStyle="danger" raised>danger</Button>&nbsp;&nbsp;
                    <Button disabled="true" raised>disabled</Button>
                </div>
                ...
                <div className="k-example">
                    ...
                    <Button kStyle="warning" fab>+</Button>&nbsp;&nbsp;
                    <Button kStyle="danger" fab>+</Button>&nbsp;&nbsp;
                    <Button disabled="true" fab>+</Button>
                </div>
                <h3>Size</h3>
                <div className="k-example">
                    <Button kStyle="primary" raised kSize="xs">xs button</Button>&nbsp;&nbsp;
                    <Button kStyle="primary" raised kSize="sm">sm button</Button>&nbsp;&nbsp;
                    <Button kStyle="primary" raised >default</Button>&nbsp;&nbsp;
                    <Button kStyle="primary" raised kSize="lg">lg button</Button>&nbsp;&nbsp;
                </div>
                <h3>Button Group</h3>
                <div className="k-example">
                    <ButtonGroup>
